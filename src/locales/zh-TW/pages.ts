export default {
  'pages.layouts.userLayout.title': 'Microworld DS 是鹹魚星最具影響力的伺服器集群',
  ...
  'pages.account.settings.profile': '個人資料',
  'pages.account.settings.avatar': '頭像設定',
  'pages.account.settings.privacy': '隱私設定',
  'pages.account.settings.password': '更改密碼',
  'pages.account.settings.other': '其他設定',
  'pages.account.settings.profile.avatar': '頭像',
  'pages.account.settings.profile.username': '使用者名稱',
  'pages.account.settings.profile.nickname': '綽號',
  'pages.account.settings.profile.email': '電郵',
  'pages.account.settings.profile.regdate': '註冊日期',
  'pages.account.settings.profile.lstlogin': '最後登入時間',
  'pages.account.settings.profile.status': '狀態',
